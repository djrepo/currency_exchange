...
public class SchemaGenerator {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final Path jsonFile = Paths.get("src","test","resources", "dump","euraud.json");
        final Path outputPath = Paths.get("target","generated-sources");
        createDictionary(outputPath);
        schemaGenerator.convertJsonToJavaClass(jsonFile.toUri().toURL(),outputPath.toFile(),"com.currency.model","EuradModel");
    }
