...
public class BidVolume {
    ...
    public BidVolume with$numberInt(String $numberInt) {
        this.$numberInt = $numberInt;
        return this;
    }
    ...
    public BidVolume withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(BidVolume.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("$numberInt");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BidVolume) == false) {
            return false;
        }
        BidVolume rhs = ((BidVolume) other);
