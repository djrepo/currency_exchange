...
public class PositionNumber {
    ...
    public PositionNumber with$numberInt(String $numberInt) {
        this.$numberInt = $numberInt;
        return this;
    }
    ...
    public PositionNumber withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(PositionNumber.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("$numberInt");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PositionNumber) == false) {
            return false;
        }
        PositionNumber rhs = ((PositionNumber) other);
